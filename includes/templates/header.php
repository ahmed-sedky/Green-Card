                        ...
                        <li class="nav-item dropdown">
                            <?php
                                ...
                                ?>
                                            ...
                                            <?php
                                                echo "<a class='dropdown-item' href='categories.php?catid=" .$c['Id'] ."&pagename=" .str_replace(" ","-",$c['Name']) ."'>" . $c['Name'] ."</a>";
                                            ?>
                                <?php
                                    }
                                    ?>
                            ...
                            echo "<li class='nav-item'><a class='nav-link' href='categories.php?catid=" .$cat['Id'] ."&pagename=" .str_replace(" ","-",$cat['Name']) ."'>" . $cat['Name'] ."</a></li>";
                        }
        ...
        if(isset($_SESSION['user'])){
            ...
            <span><?php echo date("Y-m-d h:i:sa");?></span>
                ...
                if ($userStatus == 1){
                    ...
                    <a href="login.php">
                    <span class="right btn btn-primary">Login / SignUp</span>
                    </a>
                <?php
                }
            ?>
